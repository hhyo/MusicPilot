...
class TestNeteaseDownloaderMoreBoost:
    @pytest.fixture
    def downloader(self):
...
# ============== 所有 Operation 测试 ==============
class TestAllOperationsMoreBoost:

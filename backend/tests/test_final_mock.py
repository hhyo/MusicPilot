...
class TestNeteaseDownloaderFinalMock:
    @pytest.fixture
    def downloader(self):
...
# ============== TorrentInfo 测试 ==============
class TestTorrentInfoFinalMock:
...
# ============== 所有 Operation 测试 ==============
class TestAllOperationsFinalMock:

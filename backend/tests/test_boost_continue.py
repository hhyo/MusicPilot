...
class TestNeteaseDownloaderBoostContinue:
    @pytest.fixture
    def downloader(self):
...
# ============== 所有 Chain 测试 ==============
class TestAllChainsBoostContinue:
...
# ============== 所有 Router 测试 ==============
class TestAllRoutersBoostContinue:
...
# ============== 所有 Core 测试 ==============
class TestAllCoreBoostContinue:
...
# ============== 所有 Model 测试 ==============
class TestAllModelsBoostContinue:
...
# ============== 所有 Operation 测试 ==============
class TestAllOperationsBoostContinue:
...
# ============== 所有 Schema 测试 ==============
class TestAllSchemasBoostContinue:
...
# ============== 所有 Module 测试 ==============
class TestAllModulesBoostContinue:
...
# ============== 所有 Task 测试 ==============
class TestAllTasksBoostContinue:
...
# ============== Factory 测试 ==============
class TestFactoryBoostContinue:

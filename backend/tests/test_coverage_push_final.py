...
class TestNeteaseDownloaderCoveragePush:
    @pytest.fixture
    def downloader(self):
...
# ============== EventManager 测试 ==============
class TestEventManagerCoveragePush:
...
# ============== FileCache 测试 ==============
class TestFileCacheCoveragePush:
...
# ============== TorrentInfo 测试 ==============
class TestTorrentInfoCoveragePush:
...
# ============== 所有 Chain 测试 ==============
class TestAllChainsCoveragePush:
...
# ============== 所有 Router 测试 ==============
class TestAllRoutersCoveragePush:
...
# ============== 所有 Model 测试 ==============
class TestAllModelsCoveragePush:
...
# ============== 所有 Operation 测试 ==============
class TestAllOperationsCoveragePush:
...
# ============== 所有 Schema 测试 ==============
class TestAllSchemasCoveragePush:
...
# ============== 所有 Module 测试 ==============
class TestAllModulesCoveragePush:
...
# ============== 所有 Task 测试 ==============
class TestAllTasksCoveragePush:

...
class TestNeteaseDownloaderCoverage80:
    @pytest.fixture
    def downloader(self):
...
# ============== EventManager 功能测试 ==============
class TestEventManagerCoverage80:
...
# ============== TorrentInfo 功能测试 ==============
class TestTorrentInfoCoverage80:
...
# ============== 所有 Router 测试 ==============
class TestAllRoutersCoverage80:
...
# ============== 所有 Operation 测试 ==============
class TestAllOperationsCoverage80:
...
# ============== 所有 Schema 测试 ==============
class TestAllSchemasCoverage80:
...
# ============== 所有 Module 测试 ==============
class TestAllModulesCoverage80:

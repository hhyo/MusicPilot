...
class TestNeteaseDownloaderFinalBoost:
    @pytest.fixture
    def downloader(self):
...
# ============== EventManager 测试 ==============
class TestEventManagerFinalBoost:
...
# ============== TorrentInfo 测试 ==============
class TestTorrentInfoFinalBoost:
...
# ============== 所有 Router 测试 ==============
class TestAllRoutersFinalBoost:
...
# ============== 所有 Operation 测试 ==============
class TestAllOperationsFinalBoost:
...
# ============== 所有 Schema 测试 ==============
class TestAllSchemasFinalBoost:
...
# ============== 所有 Module 测试 ==============
class TestAllModulesFinalBoost:

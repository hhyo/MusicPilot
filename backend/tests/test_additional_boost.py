...
class TestNeteaseDownloaderAdditionalBoost:
    @pytest.fixture
    def downloader(self):
...
# ============== 所有 Chain 测试 ==============
class TestAllChainsAdditionalBoost:
...
# ============== 所有 Router 测试 ==============
class TestAllRoutersAdditionalBoost:
...
# ============== 所有 Core 测试 ==============
class TestAllCoreAdditionalBoost:
...
# ============== 所有 Model 测试 ==============
class TestAllModelsAdditionalBoost:
...
# ============== 所有 Operation 测试 ==============
class TestAllOperationsAdditionalBoost:
...
# ============== 所有 Schema 测试 ==============
class TestAllSchemasAdditionalBoost:
...
# ============== 所有 Module 测试 ==============
class TestAllModulesAdditionalBoost:
...
# ============== 所有 Task 测试 ==============
class TestAllTasksAdditionalBoost:
...
# ============== Factory 测试 ==============
class TestFactoryAdditionalBoost:

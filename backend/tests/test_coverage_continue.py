...
class TestNeteaseDownloaderCoverageContinue:
    @pytest.fixture
    def downloader(self):
...
# ============== 所有 Chain 测试 ==============
class TestAllChainsCoverageContinue:
...
# ============== 所有 Router 测试 ==============
class TestAllRoutersCoverageContinue:
...
# ============== 所有 Core 测试 ==============
class TestAllCoreCoverageContinue:
...
# ============== 所有 Model 测试 ==============
class TestAllModelsCoverageContinue:
...
# ============== 所有 Operation 测试 ==============
class TestAllOperationsCoverageContinue:
...
# ============== 所有 Schema 测试 ==============
class TestAllSchemasCoverageContinue:
...
# ============== 所有 Module 测试 ==============
class TestAllModulesCoverageContinue:
...
# ============== 所有 Task 测试 ==============
class TestAllTasksCoverageContinue:
...
# ============== Factory 测试 ==============
class TestFactoryCoverageContinue:

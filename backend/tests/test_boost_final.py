...
class TestNeteaseDownloaderBoostFinal:
    @pytest.fixture
    def downloader(self):
...
# ============== 所有 Router 测试 ==============
class TestAllRoutersBoostFinal:
...
# ============== 所有 Operation 测试 ==============
class TestAllOperationsBoostFinal:
...
# ============== 所有 Schema 测试 ==============
class TestAllSchemasBoostFinal:
...
# ============== 所有 Module 测试 ==============
class TestAllModulesBoostFinal:

...
class TestNeteaseDownloaderContinueBoost:
    @pytest.fixture
    def downloader(self):
...
# ============== 所有 Chain 测试 ==============
class TestAllChainsContinueBoost:
...
# ============== 所有 Router 测试 ==============
class TestAllRoutersContinueBoost:
...
# ============== 所有 Core 测试 ==============
class TestAllCoreContinueBoost:
...
# ============== 所有 Model 测试 ==============
class TestAllModelsContinueBoost:
...
# ============== 所有 Operation 测试 ==============
class TestAllOperationsContinueBoost:
...
# ============== 所有 Schema 测试 ==============
class TestAllSchemasContinueBoost:
...
# ============== 所有 Module 测试 ==============
class TestAllModulesContinueBoost:
...
# ============== 所有 Task 测试 ==============
class TestAllTasksContinueBoost:
...
# ============== Factory 测试 ==============
class TestFactoryContinueBoost:

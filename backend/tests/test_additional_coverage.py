...
class TestNeteaseDownloaderAdditional:
    @pytest.fixture
    def downloader(self):
...
# ============== 所有 Router 测试 ==============
class TestAllRoutersAdditional:
...
# ============== 所有 Operation 测试 ==============
class TestAllOperationsAdditional:
...
# ============== 所有 Schema 测试 ==============
class TestAllSchemasAdditional:
...
# ============== 所有 Module 测试 ==============
class TestAllModulesAdditional:

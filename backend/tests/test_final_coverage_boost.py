...
class TestNeteaseDownloaderFinalCoverage:
    @pytest.fixture
    def downloader(self):
...
# ============== EventManager 功能测试 ==============
class TestEventManagerFinalCoverage:
...
# ============== FileCache 功能测试 ==============
class TestFileCacheFinalCoverage:
...
# ============== TorrentInfo 功能测试 ==============
class TestTorrentInfoFinalCoverage:
...
# ============== 所有 Chain 测试 ==============
class TestAllChainsFinalCoverage:
...
# ============== 所有 Router 测试 ==============
class TestAllRoutersFinalCoverage:
...
# ============== 所有 Core 测试 ==============
class TestAllCoreFinalCoverage:
...
# ============== 所有 Model 测试 ==============
class TestAllModelsFinalCoverage:
...
# ============== 所有 Operation 测试 ==============
class TestAllOperationsFinalCoverage:
...
# ============== 所有 Schema 测试 ==============
class TestAllSchemasFinalCoverage:
...
# ============== 所有 Module 测试 ==============
class TestAllModulesFinalCoverage:
...
# ============== 所有 Task 测试 ==============
class TestAllTasksFinalCoverage:

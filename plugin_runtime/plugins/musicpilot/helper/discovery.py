"""Discovery presentation builders for chart views."""
...
from ..schemas.orchestration import ChartDetailData, ChartEntryInfo, ChartInfo, DiscoveryEntryGroup, DiscoveryEntryView
from ..schemas.shared import EntityType


class MusicDiscoveryBuilder:
    ...
    def build_detail(self, detail: ChartDetailData) -> ChartDetailData:
        ...
        detail.summary_stats = {"items": len(entry_views), "ready": ready_count, "group_count": len(detail.entry_groups)}
        detail.recognition_summary = {"ready": ready_count, "not_ready": len(entry_views) - ready_count}
        return detail

...
class Settings(BaseSettings):
    ...
    host_api_prefix: str = Field(default="/api/v1")
    ...
    host_search_path: str | None = Field(default="/api/v1/search/title")
    ...
    host_dispatch_path: str | None = Field(default="/api/v1/download/add")

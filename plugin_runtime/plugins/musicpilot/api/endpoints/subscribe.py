...
from ...core.dependencies import get_music_subscribe_chain
...
async def list_subscriptions(
    ...
    chain: MusicSubscribeChain = Depends(get_music_subscribe_chain),
) -> ApiResponse:
    return success_response(
        request,
        data=chain.list_subscriptions(
...
async def create_subscription(
    ...
    return success_response(
        request,
        data=chain.create_subscription(payload),
...
async def get_subscription_run(
    ...
    return success_response(
        request,
        data=chain.get_run_detail(run_id),
...
async def get_subscription(
    ...
    return success_response(
        request,
        data=chain.get_subscription(subscription_id),
...
async def update_subscription(
    ...
    return success_response(
        request,
        data=chain.update_subscription(subscription_id, payload),
...
async def archive_subscription(
    ...
    return success_response(
        request,
        data=chain.archive_subscription(subscription_id),

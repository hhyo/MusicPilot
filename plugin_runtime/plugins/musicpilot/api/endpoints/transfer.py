...
from ...core.dependencies import get_music_transfer_chain
...
async def organize_jobs(
    ...
    chain: MusicTransferChain = Depends(get_music_transfer_chain),
...
async def organize_job_detail(
    ...
    result = chain.get_record(record_id)
    return success_response(
        request,
        data=result,
...
async def rebuild_organize_preview(
    ...
    result = chain.rebuild_preview(record_id)
    return success_response(
        request,
        data=result,
...
async def repair_organize_source_path(
    ...
    result = chain.repair_source_path(record_id)
    return success_response(
        request,
        data=result,
